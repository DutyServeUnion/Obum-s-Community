...
serverguard.ranks:AddRank("user", "Player", 0, Color(100, 150, 245, 255), "icon16/user.png", {
	Restrictions = {
		["Vehicles"] = 0,
		["Effects"] = 0,
		["Props"] = 80,
...
serverguard.ranks:AddRank("supporter", "Supporter", 2, Color(100, 150, 245, 255), "icon16/user.png", {
	Restrictions = {
		["Vehicles"] = 0,
		["Effects"] = 0,
		["Props"] = 170,
...
serverguard.ranks:AddRank("admin", "Administrator", 20, Color(117, 0, 211), "icon16/award_star_bronze_1.png", {
	...
	phys_color = Color(0, 35, 102)
});

serverguard.ranks:AddRank("developer", "Developer", 25, Color(100, 150, 245, 255), "icon16/user.png", {
	Restrictions = {
		["Vehicles"] = 4,
		["Effects"] = 6,
		["Props"] = 256,
	...
	phys_color = Color(28, 179, 24)
});

serverguard.ranks:AddRank("superadmin", "Super Administrator", 90, Color(0, 150, 0), "icon16/award_star_silver_1.png", {
	Permissions = {
