...
// Further Modifications by The Apex Typhon
...
function SWEP:lase(par, stat, from, to, noise)
	...
	beam = ents.Create("env_laser")
		...
		beam:SetKeyValue("rendercolor", "70 130 180")
	...
	tent:SetKeyValue("m_Color","70 130 180 255")
